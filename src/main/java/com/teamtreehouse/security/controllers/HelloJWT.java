package com.teamtreehouse.security.controllers;

import com.teamtreehouse.security.dto.AuthDTO;
import com.teamtreehouse.security.model.JwtUser;
import com.teamtreehouse.security.services.JwtService;
import com.teamtreehouse.security.services.UserService;
...
public class HelloJWT
{
    ...
    @GetMapping(value = "/api/v1/secure/hello/{name}")
    ...
    @GetMapping(value = "/api/v1/public/hello/{name}")
